...
{
    public partial class AllTeachersForm : Form
    {
        public AllTeachersForm()
        {
            InitializeComponent();
            customizeDesign();
            LoadTeachersData();
        ...
        private void LoadTeachersData()
        {
            ...
            using (SqlConnection connection = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\vihan\Documents\Skill_international_db.mdf;Integrated Security=True;Connect Timeout=30;Encrypt=False"))
            {
                try
                {
                    ...
                    DataGridView_allTeachers.DataSource = dataTable;
                }
                catch (Exception ex)
                {
        ...
        private void AllTeachersForm_Load(object sender, EventArgs e)
        {
